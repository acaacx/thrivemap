...
export function PortalProfileForm({ clinicId, directEdit, initial }: PortalProfileFormProps) {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div className="space-y-1.5">
        ...
        <Textarea id="portal-description" rows={5} {...form.register("description")} />
      ...
      <div className="space-y-1.5">
        ...
        <Input id="portal-website" placeholder="https://…" {...form.register("website")} />
      ...
      <fieldset className="space-y-3 rounded-xl border bg-card p-4">
        ...
        <CheckboxRow form={form} name="offers_in_person_services" label="In-person sessions" />
        <CheckboxRow form={form} name="offers_online_services" label="Online sessions" />
      </fieldset>

      <fieldset className="space-y-3 rounded-xl border bg-card p-4">
        <legend className="px-1 text-sm font-medium">Accessibility</legend>
        <CheckboxRow form={form} name="wheelchair_accessible" label="Wheelchair accessible" />
        <div className="space-y-1.5">
...
function CheckboxRow({
  ...
  name: "offers_in_person_services" | "offers_online_services" | "wheelchair_accessible";
  label: string;
}) {
