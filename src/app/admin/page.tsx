...
export default async function AdminDashboardPage() {
  ...
  const tiles = [
    { label: "Pending submissions", value: metrics.submissions, href: "/admin/submissions" },
    { label: "Open claims", value: metrics.claims, href: "/admin/claims" },
    { label: "Change requests", value: metrics.changeRequests, href: "/admin/change-requests" },
    { label: "Open reports", value: metrics.reports, href: "/admin/reports" },
    { label: "Duplicate candidates", value: metrics.duplicates, href: "/admin/duplicates" },
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-semibold">Moderation dashboard</h1>
      ...
      <ul className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {tiles.map((tile) => (
          <li key={tile.label}>
            ...
            >
              <p className="font-heading text-3xl font-semibold">{tile.value}</p>
