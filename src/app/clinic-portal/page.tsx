      ...
      <main id="main-content" className="flex-1">
        <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
          ...
          <p className="mt-2 text-muted-foreground">
            Manage the listings you represent — keep services, hours, and
            contact details accurate for families.
          </p>
          ...
          {clinics.length === 0 ? (
            <div className="mt-10 rounded-2xl border bg-card p-8 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
                Claim your clinic from its listing page. Once a moderator
                approves your claim, it appears here.
              </p>
              <Button
                ...
                >
                  ...
                  <div className="ml-auto flex gap-2">
                    ...
                    <Button
                      className="rounded-full"
                      render={
                        <Link href={`/clinic-portal/${clinic.id}/profile`} />
                      }
                    >
                      Manage
                    </Button>
